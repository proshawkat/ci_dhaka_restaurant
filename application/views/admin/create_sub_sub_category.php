                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                                ...
                                                <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                                    ...
                                                    <input type="hidden" name="sub_sub_category_id" value="<?php if( isset($edit['SUB_SUB_CATEGORY_ID']) && $edit['SUB_SUB_CATEGORY_ID'] ){echo $this->webspice->encrypt_decrypt($edit['SUB_SUB_CATEGORY_ID'], 'encrypt');} ?>" />
                                                    <fieldset>
                                                          ...
                                                          <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label">Sub Sub Category Name<span class="required">*</span></label>
                                                                <div class="controls">
                                                                    <input type="text" name="sub_sub_category_name" data-required="1" class="span6 m-wrap" value="<?php echo set_value('sub_sub_category_name',$edit['SUB_SUB_CATEGORY_NAME']); ?>" />
                                                                    <span class="fred"><?php echo form_error('sub_sub_category_name'); ?></span>
                                                                </div>
