                                ...
                                <div class="span12">
                                    ...
                                    <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <select class="span6 m-wrap chzn-select" name="parent_id">
                                                <option value="">Select...</option>
                                                <?php
                                                $options = $this->db->query("SELECT * FROM parent WHERE STATUS = 7")->result();
                                                ?>
                                                <?php foreach($options as $option) : ?>
                                                <option value="<?php echo $option->PARENT_ID ?>" <?php echo (isset($edit['PARENT_ID']) && $edit['PARENT_ID'] == $option->PARENT_ID) ? "selected" : ""; ?> ><?php echo $option->PARENT_NAME; ?></option>
                                                <?php endforeach; ?>
                                              </select>
